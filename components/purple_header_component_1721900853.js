...
Vue.component("purple_header_component_1721900853", {
    template: `
    <div class="flex">
        <aside class="w-64 h-screen bg-slate-800 p-5">
            <nav>
                <ul class="space-y-4">
                    <li><a href="Home.html" class="text-white hover:text-purple-400 transition duration-150 ease-in-out">Home</a></li>
                    <li><a href="About Us.html" class="text-white hover:text-purple-400 transition duration-150 ease-in-out">About</a></li>
                    <li><a href="#" class="text-white hover:text-purple-400 transition duration-150 ease-in-out">Contact</a></li>
                </ul>
            </nav>
        </aside>
                ...
                <div class="flex items-center justify-between h-16 md:h-20">
                    ...
                    <nav id="desktop-navigation" class="hidden md:flex md:grow">
                        ...
                        <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                            ...
                            <li><a id="Discover Ethereum-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Discover Ethereum.html" :class="[textStylePrimary, hoverTextStylePrimary]">Discover Ethereum</a></li>
                    ...
                    <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                        ...
                        <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                            <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                                ...
                                <li><a id="mobile-Discover Ethereum-link" class="flex font-medium text-sm py-1.5" href="Discover Ethereum.html" :class="[textStylePrimary,hoverTextStylePrimary]">Discover Ethereum</a></li>
